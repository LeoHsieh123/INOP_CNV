...
class Granite_Rapids_D(devices.common.ethspy_commands.EthSpyCommands):
    ...
    def __init__(self, port):
        ...
        super(Granite_Rapids_D, self).__init__(port)

        self.codename = 'Granite Rapids-D'
        self.interface = 'hss'
        self.snr_type = ''
    ...
    def ethspy_rx_get_ehm(self, lane):
