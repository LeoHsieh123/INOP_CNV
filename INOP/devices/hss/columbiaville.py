...
##############################################################################
"""This module is used to control Columbiaville Intel(R) Ethernet devices.

    Typical usage example:
        cvl = Columbiaville(9)
        link_status = cvl.ethspy_link_get_status()
"""
...
class Columbiaville(EthSpyCommands):
    """This class overrides and provides methods specific to Columbiaville."""

    def __init__(self, port):
        self.phy_type = 'CVL'

        super(Columbiaville, self).__init__(port)

        self.codename = 'Columbiaville'
        self.interface = 'hss'
