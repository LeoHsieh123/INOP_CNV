...
class RobotLHCWrapper:
    ...
    def list_loop(self, cable_type):
        ...
        for dut_port, dut_name, lp_port, lp_name, in zip(
            ...
            if cable_type == 'Cat5e' and self.speed in ['1GBASET', '2.5GBASET', '5GBASET']:
                if self.speed == '1GBASET':
            ...
            if cable_type == 'Cat6a' and self.speed in ['2.5GBASET', '5GBASET', '10GBASET']:
                self.es_vars['BER_TARGET'] = 1e-12
            ...
            if cable_type == 'Cat6a' and self.speed == '1GBASET':
                self.logger.info('Not testing 1G on Cat6a cable!')
                self.scoreboard[head_pos] = True
            elif cable_type == 'Cat5e' and self.speed == '10BASET':
                self.logger.info('Not testing 10G on Cat5e cable!')
                self.scoreboard[head_pos] = True
            else:
                self.prep_to_run(
                    dut,
