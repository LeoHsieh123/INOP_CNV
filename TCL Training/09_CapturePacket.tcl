...
# 取port 9的數值
# stat get statAllStats chas card port  // 取port 9數據給stat handle
...
capture get 1 1 1
captureBuffer get 1 1 1 1 5
captureBuffer getframe 1
set captureFrame [captureBuffer cget -frame]
ixPuts [capture cget -nPackets]
ixPuts $captureFrame


captureBuffer export "port1captured.cap"
ixStopPortCapture 1 1 1