...
######### Chassis-10.89.83.99 Card-1  Port-1 #########

resourceGroupEx get $chassis $card $port
resourceGroupEx config -activeCapturePortList              "{0 1 1}"
resourceGroupEx config -activePortList                     "{0 1 1}"
resourceGroupEx config -resourcePortList                   "{0 1 1} {0 1 9} {0 1 10} {0 1 25} {0 1 26} {0 1 27} {0 1 28} {0 1 57} {0 1 58} {0 1 59} {0 1 60} {0 1 61} {0 1 62} {0 1 63} {0 1 64} {0 1 121} {0 1 129} {0 1 130} {0 1 145} {0 1 146} {0 1 147} {0 1 148} {0 1 177} {0 1 178} {0 1 179} {0 1 180} {0 1 181} {0 1 182} {0 1 183} {0 1 184} {0 1 241} {0 1 249} {0 1 250} {0 1 265} {0 1 266} {0 1 267} {0 1 268} {0 1 297} {0 1 298} {0 1 299} {0 1 300} {0 1 301} {0 1 302} {0 1 303} {0 1 304} {0 1 361} {0 1 362} {0 1 377} {0 1 378} {0 1 379} {0 1 380} {0 1 381} {0 1 382} {0 1 383} {0 1 384}"
...
port config -receiveMode                        [expr $::portCapture|$::portRxModeBert|$::portRxModeWidePacketGroup]
...
port config -enableRepeatableLastRandomPattern  true
...
packetGroup config -enableLastBitTimeStamp             true
...
autoDetectInstrumentation config -startOfScan                        14
autoDetectInstrumentation config -signature                          {D5 A6 7A 21 AB 43 04 BD 49 78 69 61}
autoDetectInstrumentation config -enableSignatureMask                true
#autoDetectInstrumentation config -signatureMask  {00 00 00 00 00 00 00 00 00 00 00 00}
autoDetectInstrumentation config -enableMisdirectedPacketMask        true
autoDetectInstrumentation config -misdirectedPacketMask              {00 00 00 00 00 00 00 00 00 00 00 01}
#autoDetectInstrumentation config -enableMisdirectedAISFilterIgnore false
